...
echo ============================================
echo  Cecafe Monthly data publish
echo ============================================
echo.

echo Step 1/3: Validating Cecafe Monthly.xlsx ...
python validate_xlsx.py
if errorlevel 1 (
    echo.
    echo ============================================
    echo  VALIDATION FAILED - nothing was pushed.
    echo  Fix the issues above in "Database\Cecafe Monthly.xlsx", then run this again.
    echo ============================================
    pause
    exit /b 1
)
...
git diff --quiet -- "Database\Cecafe Monthly.xlsx"
if not errorlevel 1 (
    echo No changes detected in "Database\Cecafe Monthly.xlsx" - nothing to push.
    pause
    exit /b 0
)
...
git add "Database\Cecafe Monthly.xlsx"
